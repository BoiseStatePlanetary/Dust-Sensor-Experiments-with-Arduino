...
/*  
  ...
  Serial.print("The current adcvalue is: ");
  Serial.print(adcvalue);
  Serial.print("\n\n");  

*/  

  Serial.print("(SYS_VOLTAGE / 1024.0) * (double) adcvalue * 11.0, adcvalue, voltage, density: ");
  Serial.print((SYS_VOLTAGE / 1024.0) * (double) adcvalue * 11.0);
  Serial.print(" ");  
  Serial.print(adcvalue);
  Serial.print(" ");  
  Serial.print(voltage);
